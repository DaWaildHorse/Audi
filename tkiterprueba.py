...
# Dentro de tkiterprueba.py
def iniciar_ventana_principal():
    # El código de tu ventana principal de Tkinter aquí
    root = Tk()
    # Configurar la ventana principal...
    root.mainloop()

# Solo ejecuta la ventana principal si este archivo es el archivo principal ejecutado
